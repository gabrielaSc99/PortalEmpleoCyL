 ...
 * IMPORTANTE: Responde inmediatamente y ejecuta en segundo plano para evitar timeout
 */
...
// Marcar que se esta ejecutando para evitar duplicados
Cache::guardar('ultima_sincronizacion', date('Y-m-d H:i:s'));

// Responder inmediatamente al cliente (cron-job.org)
// para evitar timeout de 30 segundos
echo json_encode([
    'estado' => 'iniciado',
...
// Cerrar conexion con el cliente pero seguir ejecutando
if (function_exists('fastcgi_finish_request')) {
    fastcgi_finish_request();
} else {
    // Alternativa para servidores sin fastcgi
...
// Aumentar tiempo de ejecucion para la sincronizacion
set_time_limit(300); // 5 minutos

// Ejecutar sincronizacion en segundo plano
ob_start();
